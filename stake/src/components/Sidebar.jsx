  ...
  return (
    ...
    >
      ...
      >
        ...
        <div class="hoverable svelte-byqul" style={{ display: "flex" }}>
      ...
      <div
        className="w-10 section-wrapper top svelte-0cl0jp bg-[#0f212e] pt-0"
