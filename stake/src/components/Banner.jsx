const Banner = ({ data }) => {
  return (
    <section class="main1 w-full bg-gray-900 py-12 px-4 md:px-8 ">
      {" "}
      {/* Add overflow-auto here */}
      <div class="overflow-x-auto scrollbar-hide">
        <div class="flex flex-col-reverse md:flex-row max-w-[1200px] mx-auto gap-8 items-center">
          <div class="text-center md:text-left lg:max-w-[478px]">
            ...
            <div class="oauth h-full w-full justify-end md:items-start mt-20">
              ...
              <div class="flex gap-2" style={{ justifyContent: "flex-start" }}>
                ...
                <button class="inline-flex relative items-center gap-2 justify-center rounded-sm font-semibold whitespace-nowrap ring-offset-background transition disabled:pointer-events-none disabled:opacity-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 active:scale-[0.98] bg-grey-400 text-white betterhover:hover:bg-grey-300 betterhover:hover:text-white focus-visible:outline-white text-sm leading-none shadow-md py-[0.8125rem] px-[1rem]">
                  <svg
                ...
                <button class="inline-flex relative items-center gap-2 justify-center rounded-sm font-semibold whitespace-nowrap ring-offset-background transition disabled:pointer-events-none disabled:opacity-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 active:scale-[0.98] bg-grey-400 text-white betterhover:hover:bg-grey-300 betterhover:hover:text-white focus-visible:outline-white text-sm leading-none shadow-md py-[0.8125rem] px-[1rem]">
                  <svg fill="none" viewBox="0 0 97 96" className="svg-icon">
                    <path
          ...
          <div class="grid grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            >
              ...
              >
                {data && <img src={data.images[0]} alt="Game Preview" />}
              </div>
            </div>
            <div
              style={{
            ...
            >
              <div
                ...
                style={{ border: "2px solid var(--border-color)" }}
              >
                {data && <img src={data.images[1]} alt="Team Preview" />}
              </div>
            </div>
          </div>
        </div>
